...
[![](https://contrib.rocks/image?repo=wisehackermonkey/netlify-function-test)](https://github.com/wisehackermonkey/netlify-function-test/graphs/contributors)
...
# License
#### MIT © wisehackermonkey
[![MIT](https://img.shields.io/github/license/wisehackermonkey/netlify-function-test.svg)](https://github.com/wisehackermonkey/netlify-function-test/blob/master/LICENSE)
-->
...
[![GitHub release](https://img.shields.io/github/release/wisehackermonkey/netlify-function-test.svg)](https://GitHub.com/wisehackermonkey/netlify-function-test/releases/)
[![GitHub tag](https://img.shields.io/github/tag/wisehackermonkey/netlify-function-test.svg)](https://GitHub.com/wisehackermonkey/netlify-function-test/tags/)
[![GitHub pull-requests](https://img.shields.io/github/issues-pr/wisehackermonkey/netlify-function-test.svg)](https://GitHub.com/wisehackermonkey/netlify-function-test/pull/)
...
```bash
cd ~
git clone https://github.com/wisehackermonkey/netlify-function-test.git
cd netlify-function-test
...
git clone https://github.com/wisehackermonkey/netlify-function-test.git
cd netlify-function-test
docker build -t wisehackermonkey/netlify-function-test:latest .  
```
### Run
```bash
docker run -it --rm --name wisehackermonkey/netlify-function-test:latest  
```
### Docker-compose
```bash
...
docker build -t wisehackermonkey/netlify-function-test:latest .
docker login
docker push wisehackermonkey/netlify-function-test:latest
```
